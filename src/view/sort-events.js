...
const createSortTripEvent = (currentSortType) => {
  return (
...
export default class SortTripEvent extends AbstractView {
  ...
  getTemplate() {
    return createSortTripEvent(this._currentSortType);
  }
